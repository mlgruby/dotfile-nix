...

{
  ...
  fonts = {
    fontconfig = {
      ...
      defaultFonts = {
        ...
        monospace = [ 
          "JetBrainsMono NFM"        # Primary coding, no ligatures
  ...
  home.sessionVariables = {
    ...
    TERMINAL_FONT = "JetBrainsMono NFM";
    EDITOR_FONT = "JetBrainsMono NFM";
    UI_FONT = "Inter";
  ...
  home.file.".config/fontconfig/fonts.conf".text = ''
    ...
    <fontconfig>
      ...
      <match target="pattern">
        ...
        <edit name="family" mode="assign" binding="same"><string>JetBrainsMono NFM</string></edit>
      </match>
  ...
  home.file = {
    ...
    ".config/fonts/homebrew-fonts.md".text = ''
      ...
      All fonts managed via Homebrew for optimal macOS integration.
             ...
             ## Primary Fonts:
       - JetBrainsMono NFM (coding/terminal)
       - Inter (UI/sans-serif)  
    ...
    ".config/fonts/test-fonts.sh".text = ''
      ...
      echo
       ...
       echo "  Serif: Source Serif 4 sample (documents)"
        echo "  Mono: JetBrainsMono NFM sample (code)"
      echo
