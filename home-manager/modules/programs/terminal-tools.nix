...
# - Case-insensitive completion for Readline-based tools
# - Automatic tealdeer cache updates
# - Optimized info and man page access
# - Enhanced pager functionality
#
# Integration:
# - Complements native Zsh configuration; it does not configure Zsh completion
  ...
  programs = {
    ...
    readline = {
      ...
      variables = {
        ...
        completion-ignore-case = true; # Case-insensitive Readline completion
        completion-map-case = true; # Map case during Readline completion
