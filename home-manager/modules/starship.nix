...
{ config, lib, ... }:
let
  cfg = config.programs.starship.custom;
  symbols = cfg.languageSymbols;
in
{
  options.programs.starship.custom = {
    languageSymbols = lib.mkOption {
      ...
      description = "Language symbols for Starship prompt";
    };
  };
    ...
    programs.starship = {
      ...
      settings = {
        ...
        directory = {
          ...
          truncation_symbol = "…/";
          substitutions = {
            # Gruvbox substitutions for text to icons
            "Documents" = "󰈙 ";
            "Downloads" = " ";
            "Music" = "󰝚 ";
            "Pictures" = " ";
