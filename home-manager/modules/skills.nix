...
in
{
  ...
  # Replace the old manually-linked skill directory with the declarative
  # Home Manager link generated by programs.codex.skills.
  home.file.".codex/skills/media-use".force = true;
}
